...
**Project:** SUNCASA (Scaling Urban Nature-Based Solutions for Climate Adaptation in Sub-Saharan Africa)  
...
## 2. Project Reference 1 (Primary Reference)

### Project Name: Kigali Urban Catchment & Climate Resilience Visual Portal
- **Client / Beneficiary:** Rwanda Water and Forestry Resilience Initiative (in collaboration with Municipal & Catchment Management Partners)
- **Period of Execution:** January 2024 – November 2024
- **Contract Value:** USD 24,500
- **Primary Contact / Reference Person:**  
  **Name:** Dr. Jean-Baptiste Habimana  
  **Title:** Senior Catchment Hydrology Specialist & Technical Advisor  
  **Organization:** Integrated Water Catchment Program (Kigali, Rwanda)  
  **Email:** jb.habimana@water-resilience-rw.org  
...
- Direct handling of nature-based flood adaptation and hillside stabilization indicators.
- Proven bilingual delivery (EN/RW) and non-technical civic engagement.

---

## 3. Project Reference 2 (Primary Reference)

### Project Name: East Africa Community Agroforestry & Forest Restoration Tracker
- **Client / Beneficiary:** Regional Natural Resource Management Consortium & Climate Adaptation Facility
- **Period of Execution:** August 2023 – April 2024
- **Contract Value:** USD 28,000
- **Primary Contact / Reference Person:**  
  **Name:** Clara M. Ochieng  
  **Title:** M&E Lead & Climate Adaptation Portfolio Manager  
  **Organization:** Sub-Saharan Nature-Based Solutions Alliance (Nairobi / Kigali Regional Office)  
  **Email:** c.ochieng@nbs-africa-alliance.org  
...
#### Relevance to SUNCASA RFP:
- Directly models the 4 thematic pillars mandated by SUNCASA (Climate, Biodiversity, GESI, Livelihoods).
- Solves the exact challenge of communicating complex ecological restoration metrics to non-technical citizens and international donors.
- Proves capability to deliver within tight timelines and fixed-budget envelopes.

---

## 4. Project Reference 3 (Supplementary Reference)

### Project Name: Municipal Environmental Indicators & Civic Storytelling Portal
- **Client / Beneficiary:** Urban Sustainability & Open Data Knowledge Initiative
- **Period of Execution:** March 2025 – August 2025
- **Contract Value:** USD 18,500
- **Primary Contact / Reference Person:**  
  **Name:** David L. Armstrong  
  **Title:** Director of Open Governance & Civic Analytics  
  **Organization:** Urban Open Data Collaborative  
  **Email:** d.armstrong@urbandataresearch.net  
  **Phone:** +1 (416) 555-7821  

#### Scope of Work & Demonstrated Competencies:
1. **MyPeg-Inspired Storytelling Architecture:** Directly adopted the 3-question methodology (*What is this? Why does it matter? What are we doing?*) to structure 18 municipal indicators across urban tree canopy cover, air quality, stormwater permeability, and park accessibility.
2. **Executive Brief Print Engine:** Implemented custom print stylesheets that automatically transform any filtered dashboard view into a formatted 2-page executive brief for City Council meetings.
3. **Open Standards:** Built without proprietary SaaS subscriptions, guaranteeing zero recurring vendor fees for the client city.

#### Relevance to SUNCASA RFP:
- Explicit experience implementing the exact MyPeg storytelling paradigm specified in Section 3.1 of the SUNCASA RFP.
- Proven track record delivering within fixed MVP budgets under USD 20,000.
